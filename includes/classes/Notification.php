...
class Notification {
	...
	public function getNotifications($data, $limit) {
		...
		echo '<div class="msg_top">Notifications</div>';
		while($row = mysqli_fetch_array($query)) {
			...
			$opened = $row['opened'];
			$style = ($opened == 'no') ? "background-color: var(--drop-hov);" : "";

			$return_string .= "<a href='" . $row['link'] . "'> 
									<div class='resultDisplay resultDisplayNotification' style='border:none;" . $style . "'>
