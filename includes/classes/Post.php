		...
		if($check_empty !="" || $imageName != "") {
			...
			foreach($body_array as $key => $value) {
				...
				if(strpos($value, "www.youtube.com/watch?v=") !== false) {
					...
					$value = "<br><iframe width=\'100%\' height=\'450\'  border=\'none\'src=\'" . $value ."\'></iframe><br>";
		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			while($row = mysqli_fetch_array($data_query)) {
				...
				if($row['user_to'] == "none") {
					...
					$user_to = "<i class='fas fa-angle-double-right'></i> <a href='" . $row['user_to'] ."'>" . $user_to_name . "</a>";
				}
				...
				$user_logged_obj = new User($this->con, $userLoggedIn);
					...
					$delete_button = "<button class='delete_btn_style ' id='post$id'>Delete</button>";
					else 
					$delete_button = "";
					...
					$str .= "<div class='status_post' onClick='javascript:toggle$id()'>
								...
								<div class='posted_by' style='color:#ACACAC;'>
									<a href='$added_by'> $first_name $last_name </a> $user_to &nbsp;&nbsp;<div class='style_s'>$time_message</div>
								</div>
								...
								<div id='post_body'>
									...
									<br>
									<br>
								<span class='Cm_D'>Comments($comments_check_num)</span>
								<div class=''>
									$delete_button
								</div>
								<div class='newsfeedPostOptions'>
									<span class='Cm_D'><i class='fal fa-comment-alt-lines'></i></span>
									<iframe src='like.php?post_id=$id' scrolling='no'></iframe>
								</div>
									
								</div>
							</div>
							<div class='post_comment' id='toggleComment$id' style='display:none; background-color:white; padding:0;'>
