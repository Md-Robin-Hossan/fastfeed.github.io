...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/fastfeed/assets/images/profile_pics';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			die ('File didnt upload because You not choose file');
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        <div class="up-box"><p class="up-heading">Set Your Profile Picture</p><br /><br />
	        <input type="file" id="image" name="image" class="upload-box"/><br /><br />
	        <input type="submit" value="Submit" class="accept_button" />
</div>
	    </form><br /><br />
